...
const tests = method =>
{
	...
	it("does not support invalid directives", () =>
	{
		// https://github.com/stevenvachon/robot-directives/pull/1
		expect( newInstance({ method, directives:"nofollow,noindex,\nnone" }).oneIs(["nofollow", "noindex", "none"]) ).to.be.false;
	});
